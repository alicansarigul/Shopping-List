...
//listeye yeni eleman eklemek için kullanılacak fonksiyonlar
...
//prepend fonksiyonu listenin en başına eklemek için kullanılan fonksiyondur.

function generateId(){
    return Date.now().toString();
}
//burada benzersiz bir id üretmek için şuanki tarih için olan milisaniye süresini stringe çevirdik.

//listedeki elemanlardan tamamlananların üstünü çizmek için gerekli olan fonksiyon.
...
//listedeki elemanları silmeye yarayacak olan fonksiyon.
function removeItem(e){
    const li =e.target.parentElement;
    shoppingList.removeChild(li);
    saveToLS();
}
//remove özelliği silmeye yarar. kullanımı ise yukarıdaki gibidir. örneğin bir elemanın alt elemanını silmek istediğinizde onun ismini ardından removeChild metodunu ve tanımladığınız şeyin silinmesi için parametresine onun ismini yazmanız gerekmektedir.


//hasAttribute metodu şu işe yarar örneğin bir attribute özelliği varsa onun var olup olmadığını kontrol etmemize yarar. contentEditable ise düzenlemeye yarayan koddur. True ise düzenleyebiliriz.
